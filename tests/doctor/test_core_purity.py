...
"""
Purity test: core/ subpackage must import only numpy (no torch / lerobot / etc).
"""
...
def test_core_imports_numpy_only():
    """Importing every core submodule must not pull in torch, transformers, lerobot, or qwen_vl_utils."""
