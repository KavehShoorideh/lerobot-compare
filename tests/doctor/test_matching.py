...
"""Tests for matching.py -- rung selection and pairing logic."""
...
def test_exact_key_match_preferred():
    """Exact key matching is used when both sides share a key."""
...
def test_unpaired_fallback_still_pairs():
    """Unpaired fallback pairs all trials when no keys or covariates exist."""
